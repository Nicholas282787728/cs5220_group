...
// Tranpose of matrix
void trans(const double * restrict A, double * restrict At, const int m) {
  for (int i = 0; i < m; i++) {
    for (int j = 0; j < m; j++) {
      At[i*m + j] = A[i + j*m];
    }
...
void printMatrixC(const double * restrict A, const int n) {
  for (int i = 0; i < n; i++) {
    for (int j = 0; j < n; j++) {
      printf("%f ", A[j*n + i]);
    }
...
void printMatrixR(const double * restrict A, const int n) {
  for (int i = 0; i < n; i++) {
    for (int j = 0; j < n; j++) {
      printf("%f ", A[i + j*n]);
    }
...
void bijectA(const double * restrict A, double * restrict At, const int n, const int m, const int odd) {
  if (odd == 0) {
    for (int j = 0; j<n; j++) {
      for (int i = 0; i < m; i++) {
...
void bijectB(const double * restrict B, double * restrict Bt, const int n, const int m, const int odd) {
